...
function computePDF(data) {
    ...
    var mf_rows = [
        ...
        ["Identity bus annual maintenance",  "-", "-", numeral(data.mf_solution.year2.identity_bus_annual_maintenance()).format("$0,0"), numeral(data.mf_solution.year3.identity_bus_annual_maintenance()).format("$0,0"), numeral(data.mf_solution.year4.identity_bus_annual_maintenance()).format("$0,0"), numeral(data.mf_solution.year5.identity_bus_annual_maintenance()).format("$0,0")],
        ...
        ["Total Recurring Costs - Micro Focus Solution",  "-", "-", numeral(data.mf_solution.year2.total_recurring_costs()).format("$0,0"), numeral(data.mf_solution.year3.total_recurring_costs()).format("$0,0"), numeral(data.mf_solution.year4.total_recurring_costs()).format("$0,0"), numeral(data.mf_solution.year5.total_recurring_costs()).format("$0,0")],
        [""],
