...
function sendDataToServer(survey) {
    ...
    $("#results_listing").html(function(){
        ...
        html += "<a href='#' onclick='genPDF()'><h5>Download Report</h5></a><br>"
...
function computePDF(data) {
    ...
    doc.setFontSize(10);
    doc.text(1,1.55,"The following IAM report has been generated for the client listed above based on the")
    doc.text(1,1.725,"provided information. This report is a guide on the value proposition of a \"green fields\" IAM")
    doc.text(1,1.900,"deployment and the time to value for both identity and access management (including")
    doc.text(1,2.075,"governance). These calculations use industry values for effort where appropriate and the")
    doc.text(1,2.250,"methodology is provided at our corporate blog. These are a guide and do not factor in any ")
    doc.text(1,2.425,"existing/custom (brown fields) IAM services or any related transformation activities. We")
    doc.text(1,2.600,"recommend the use of our, or our partners, consulting services to provide the next level")
    doc.text(1,2.775,"of accuracy once the business case has been approved.")
    doc.setFontSize(6)
    ...
    doc.text(7,1.720,`${(data.formData.prep.prep_email == undefined)?"":data.formData.prep.prep_email}`)
    doc.text(7,1.895,`${(data.formData.prep.prep_other == undefined)?"":data.formData.prep.prep_other}`)
    ...
    let copyright = "© Copyright Micro Focus or one of its affiliates";
    doc.text(1, 8.31, copyright)
    
    doc.setTextColor(0)
    doc.setFontType("bold")
    doc.setFontSize(11)
    doc.text(1.25,3.2,"Do Nothing Cost: 5 Yr")
    doc.text(4,3.2,"Micro Focus Cost: 5 Yr")
    doc.text(7,3.2,"Total Savings: 5 Yr") 
    doc.setTextColor(204, 54, 49)
    doc.setFontSize(36)
    doc.text(1.25, 3.75, numeral(data.total_costs.total.do_nothing()).format('$0,0'))
    doc.text(4, 3.75, numeral(data.total_costs.total.mf_solution()).format('$0,0'))

    doc.setTextColor(74, 116, 181)
    doc.text(7, 3.75, numeral(data.quantitative_benefits.total()).format('$0,0'))
    ...
    var dn_columns = ["Do-Nothing Option - Quantitative Costs", "Year 0 - Current\nstatus without\nMicro Focus\nsolution", "Year 1", "Year 2", "Year 3", "Year 4", "Year 5", "Total"];
    var dn_rows = [
        ["Recurring Costs - Do-Nothing Option"],
        ["Entitlement Governance", numeral(data.doNothingOption.year0.entitlement_governance()).format("$0,0"), numeral(data.doNothingOption.year1.entitlement_governance()).format("$0,0"), numeral(data.doNothingOption.year2.entitlement_governance()).format("$0,0"), numeral(data.doNothingOption.year3.entitlement_governance()).format("$0,0"), numeral(data.doNothingOption.year4.entitlement_governance()).format("$0,0"), numeral(data.doNothingOption.year5.entitlement_governance()).format("$0,0"), numeral(data.doNothingOption.total.entitlement_governance()).format("$0,0")],
        ["Activity Governance",  numeral(data.doNothingOption.year0.activity_governance()).format("$0,0"), numeral(data.doNothingOption.year1.activity_governance()).format("$0,0"), numeral(data.doNothingOption.year2.activity_governance()).format("$0,0"), numeral(data.doNothingOption.year3.activity_governance()).format("$0,0"), numeral(data.doNothingOption.year4.activity_governance()).format("$0,0"), numeral(data.doNothingOption.year5.activity_governance()).format("$0,0"), numeral(data.doNothingOption.total.activity_governance()).format("$0,0")],
        ["Activity Governance - Compliance",  numeral(data.doNothingOption.year0.activity_governance_compliance()).format("$0,0"), numeral(data.doNothingOption.year1.activity_governance_compliance()).format("$0,0"), numeral(data.doNothingOption.year2.activity_governance_compliance()).format("$0,0"), numeral(data.doNothingOption.year3.activity_governance_compliance()).format("$0,0"), numeral(data.doNothingOption.year4.activity_governance_compliance()).format("$0,0"), numeral(data.doNothingOption.year5.activity_governance_compliance()).format("$0,0"), numeral(data.doNothingOption.total.activity_governance_compliance()).format("$0,0")],
        ["Account Fulfilment / Provisioning - Turn-Over",  numeral(data.doNothingOption.year0.account_fulfilment_provisioning_turn_over()).format("$0,0"), numeral(data.doNothingOption.year1.account_fulfilment_provisioning_turn_over()).format("$0,0"), numeral(data.doNothingOption.year2.account_fulfilment_provisioning_turn_over()).format("$0,0"), numeral(data.doNothingOption.year3.account_fulfilment_provisioning_turn_over()).format("$0,0"), numeral(data.doNothingOption.year4.account_fulfilment_provisioning_turn_over()).format("$0,0"), numeral(data.doNothingOption.year5.account_fulfilment_provisioning_turn_over()).format("$0,0"), numeral(data.doNothingOption.total.account_fulfilment_provisioning_turn_over()).format("$0,0")],
        ["Registrations",  numeral(data.doNothingOption.year0.registrations()).format("$0,0"), numeral(data.doNothingOption.year1.registrations()).format("$0,0"), numeral(data.doNothingOption.year2.registrations()).format("$0,0"), numeral(data.doNothingOption.year3.registrations()).format("$0,0"), numeral(data.doNothingOption.year4.registrations()).format("$0,0"), numeral(data.doNothingOption.year5.registrations()).format("$0,0"), numeral(data.doNothingOption.total.registrations()).format("$0,0")],
        ["Password Reset",  numeral(data.doNothingOption.year0.password_reset()).format("$0,0"), numeral(data.doNothingOption.year1.password_reset()).format("$0,0"), numeral(data.doNothingOption.year2.password_reset()).format("$0,0"), numeral(data.doNothingOption.year3.password_reset()).format("$0,0"), numeral(data.doNothingOption.year4.password_reset()).format("$0,0"), numeral(data.doNothingOption.year5.password_reset()).format("$0,0"), numeral(data.doNothingOption.total.password_reset()).format("$0,0")],
        ["IT Fulfilment - Change",  numeral(data.doNothingOption.year0.it_fulfilment_change()).format("$0,0"), numeral(data.doNothingOption.year1.it_fulfilment_change()).format("$0,0"), numeral(data.doNothingOption.year2.it_fulfilment_change()).format("$0,0"), numeral(data.doNothingOption.year3.it_fulfilment_change()).format("$0,0"), numeral(data.doNothingOption.year4.it_fulfilment_change()).format("$0,0"), numeral(data.doNothingOption.year5.it_fulfilment_change()).format("$0,0"), numeral(data.doNothingOption.total.it_fulfilment_change()).format("$0,0")],
        ["Helpdesk Fulfilment - Change",  numeral(data.doNothingOption.year0.helpdesk_fulfilment_change()).format("$0,0"), numeral(data.doNothingOption.year1.helpdesk_fulfilment_change()).format("$0,0"), numeral(data.doNothingOption.year2.helpdesk_fulfilment_change()).format("$0,0"), numeral(data.doNothingOption.year3.helpdesk_fulfilment_change()).format("$0,0"), numeral(data.doNothingOption.year4.helpdesk_fulfilment_change()).format("$0,0"), numeral(data.doNothingOption.year5.helpdesk_fulfilment_change()).format("$0,0"), numeral(data.doNothingOption.total.helpdesk_fulfilment_change()).format("$0,0")],
        ["Workflow",  numeral(data.doNothingOption.year0.workflow()).format("$0,0"), numeral(data.doNothingOption.year1.workflow()).format("$0,0"), numeral(data.doNothingOption.year2.workflow()).format("$0,0"), numeral(data.doNothingOption.year3.workflow()).format("$0,0"), numeral(data.doNothingOption.year4.workflow()).format("$0,0"), numeral(data.doNothingOption.year5.workflow()).format("$0,0"), numeral(data.doNothingOption.total.workflow()).format("$0,0")],
        ["Decision Analytics - Auto approvals",  numeral(data.doNothingOption.year0.decision_analytics_auto_approvals()).format("$0,0"), numeral(data.doNothingOption.year1.decision_analytics_auto_approvals()).format("$0,0"), numeral(data.doNothingOption.year2.decision_analytics_auto_approvals()).format("$0,0"), numeral(data.doNothingOption.year3.decision_analytics_auto_approvals()).format("$0,0"), numeral(data.doNothingOption.year4.decision_analytics_auto_approvals()).format("$0,0"), numeral(data.doNothingOption.year5.decision_analytics_auto_approvals()).format("$0,0"), numeral(data.doNothingOption.total.decision_analytics_auto_approvals()).format("$0,0")],
        ["Decision Analytics - Decision support",  numeral(data.doNothingOption.year0.decision_analytics_decision_support()).format("$0,0"), numeral(data.doNothingOption.year1.decision_analytics_decision_support()).format("$0,0"), numeral(data.doNothingOption.year2.decision_analytics_decision_support()).format("$0,0"), numeral(data.doNothingOption.year3.decision_analytics_decision_support()).format("$0,0"), numeral(data.doNothingOption.year4.decision_analytics_decision_support()).format("$0,0"), numeral(data.doNothingOption.year5.decision_analytics_decision_support()).format("$0,0"), numeral(data.doNothingOption.total.decision_analytics_decision_support()).format("$0,0")],
        ["Identity Bus Dev/Test Cost",  numeral(data.doNothingOption.year0.identity_bus_dev_test_cost()).format("$0,0"), numeral(data.doNothingOption.year1.identity_bus_dev_test_cost()).format("$0,0"), numeral(data.doNothingOption.year2.identity_bus_dev_test_cost()).format("$0,0"), numeral(data.doNothingOption.year3.identity_bus_dev_test_cost()).format("$0,0"), numeral(data.doNothingOption.year4.identity_bus_dev_test_cost()).format("$0,0"), numeral(data.doNothingOption.year5.identity_bus_dev_test_cost()).format("$0,0"), numeral(data.doNothingOption.total.identity_bus_dev_test_cost()).format("$0,0")],
        ["Identity Bus Point-to-Point Maintenance",  numeral(data.doNothingOption.year0.identity_bus_point_to_point_maintenance()).format("$0,0"), numeral(data.doNothingOption.year1.identity_bus_point_to_point_maintenance()).format("$0,0"), numeral(data.doNothingOption.year2.identity_bus_point_to_point_maintenance()).format("$0,0"), numeral(data.doNothingOption.year3.identity_bus_point_to_point_maintenance()).format("$0,0"), numeral(data.doNothingOption.year4.identity_bus_point_to_point_maintenance()).format("$0,0"), numeral(data.doNothingOption.year5.identity_bus_point_to_point_maintenance()).format("$0,0"), numeral(data.doNothingOption.total.identity_bus_point_to_point_maintenance()).format("$0,0")],
        ["Single Sign On",  numeral(data.doNothingOption.year0.single_sign_on()).format("$0,0"), numeral(data.doNothingOption.year1.single_sign_on()).format("$0,0"), numeral(data.doNothingOption.year2.single_sign_on()).format("$0,0"), numeral(data.doNothingOption.year3.single_sign_on()).format("$0,0"), numeral(data.doNothingOption.year4.single_sign_on()).format("$0,0"), numeral(data.doNothingOption.year5.single_sign_on()).format("$0,0"), numeral(data.doNothingOption.total.single_sign_on()).format("$0,0")],
        ["Access Bus Dev/Test Cost",  numeral(data.doNothingOption.year0.access_bus_dev_test_cost()).format("$0,0"), numeral(data.doNothingOption.year1.access_bus_dev_test_cost()).format("$0,0"), numeral(data.doNothingOption.year2.access_bus_dev_test_cost()).format("$0,0"), numeral(data.doNothingOption.year3.access_bus_dev_test_cost()).format("$0,0"), numeral(data.doNothingOption.year4.access_bus_dev_test_cost()).format("$0,0"), numeral(data.doNothingOption.year5.access_bus_dev_test_cost()).format("$0,0"), numeral(data.doNothingOption.total.access_bus_dev_test_cost()).format("$0,0")],
        ["Custom Access Maintenance",  numeral(data.doNothingOption.year0.custom_access_maintenance()).format("$0,0"), numeral(data.doNothingOption.year1.custom_access_maintenance()).format("$0,0"), numeral(data.doNothingOption.year2.custom_access_maintenance()).format("$0,0"), numeral(data.doNothingOption.year3.custom_access_maintenance()).format("$0,0"), numeral(data.doNothingOption.year4.custom_access_maintenance()).format("$0,0"), numeral(data.doNothingOption.year5.custom_access_maintenance()).format("$0,0"), numeral(data.doNothingOption.total.custom_access_maintenance()).format("$0,0")],
        [""],
        ["TOTAL Recurring Costs - Do-Nothing Option",  numeral(data.doNothingOption.year0.total_recurring_costs()).format("$0,0"), numeral(data.doNothingOption.year1.total_recurring_costs()).format("$0,0"), numeral(data.doNothingOption.year2.total_recurring_costs()).format("$0,0"), numeral(data.doNothingOption.year3.total_recurring_costs()).format("$0,0"), numeral(data.doNothingOption.year4.total_recurring_costs()).format("$0,0"), numeral(data.doNothingOption.year5.total_recurring_costs()).format("$0,0"), numeral(data.doNothingOption.total.total_recurring_costs()).format("$0,0")]
    ];

    doc.autoTable(dn_columns, dn_rows, {
        styles:{
            overflow: 'linebreak',
            fontSize: 7,
            columnWidth: 'auto'
    ...
    var mf_columns = ["Micro Focus Solution - Quantitative Costs", "Year 0 - Current\nstatus without\nMicro Focus\nsolution", "Year 1", "Year 2", "Year 3", "Year 4", "Year 5", "Total"];
    var mf_rows = [
        ["NON-RECURRING COSTS - Micro Focus Solution"],
        ["Micro Focus License", "-", numeral(data.mf_solution.year1.mf_license()).format("$0,0"), "-", "-", "-", "-", numeral(data.mf_solution.total.mf_license()).format("$0,0")],
        ["Micro Focus Initial Support & Maintenance",  "-", numeral(data.mf_solution.year1.mf_initial_support_maintenance()).format("$0,0"), "-", "-", "-", "-", numeral(data.mf_solution.total.mf_initial_support_maintenance()).format("$0,0")],
        ["Micro Focus Solution Implementation",  "-", numeral(data.mf_solution.year1.mf_solution_implementation()).format("$0,0"), "-", "-", "-", "-", numeral(data.mf_solution.total.mf_solution_implementation()).format("$0,0")],
        ["Total Non-recurring Costs - Micro Focus Solution", "-", numeral(data.mf_solution.year1.total_non_recurring_costs()).format("$0,0"), "-", "-", "-", "-", numeral(data.mf_solution.total.total_non_recurring_costs()).format("$0,0")],
        [""],
        ["RECURRING COSTS - Micro Focus Solution"],
        ["Identity bus annual maintenance",  "-", "-", numeral(data.mf_solution.year2.identity_bus_annual_maintenance()).format("$0,0"), numeral(data.mf_solution.year3.identity_bus_annual_maintenance()).format("$0,0"), numeral(data.mf_solution.year4.identity_bus_annual_maintenance()).format("$0,0"), numeral(data.mf_solution.year5.identity_bus_annual_maintenance()).format("$0,0"), numeral(data.mf_solution.total.identity_bus_annual_maintenance()).format("$0,0")],
        ["Access Bus annual maintenance", "-", "-", numeral(data.mf_solution.year2.access_bus_annual_maintenance()).format("$0,0"), numeral(data.mf_solution.year3.access_bus_annual_maintenance()).format("$0,0"), numeral(data.mf_solution.year4.access_bus_annual_maintenance()).format("$0,0"), numeral(data.mf_solution.year5.access_bus_annual_maintenance()).format("$0,0"), numeral(data.mf_solution.total.access_bus_annual_maintenance()).format("$0,0")],
        ["On-going Micro Focus Support & Maintenance",  "-", "-", numeral(data.mf_solution.year2.ongoing_mf_support_maintenance()).format("$0,0"), numeral(data.mf_solution.year3.ongoing_mf_support_maintenance()).format("$0,0"), numeral(data.mf_solution.year4.ongoing_mf_support_maintenance()).format("$0,0"), numeral(data.mf_solution.year5.ongoing_mf_support_maintenance()).format("$0,0"), numeral(data.mf_solution.total.ongoing_mf_support_maintenance()).format("$0,0")],
        ["Total Recurring Costs - Micro Focus Solution",  "-", "-", numeral(data.mf_solution.year2.total_recurring_costs()).format("$0,0"), numeral(data.mf_solution.year3.total_recurring_costs()).format("$0,0"), numeral(data.mf_solution.year4.total_recurring_costs()).format("$0,0"), numeral(data.mf_solution.year5.total_recurring_costs()).format("$0,0"), numeral(data.mf_solution.total.total_recurring_costs()).format("$0,0")],
        [""],
        ["Total Costs - Do-Nothing Option", numeral(data.total_costs.year0.do_nothing()).format("$0,0"), numeral(data.total_costs.year1.do_nothing()).format("$0,0"), numeral(data.total_costs.year2.do_nothing()).format("$0,0"), numeral(data.total_costs.year3.do_nothing()).format("$0,0"), numeral(data.total_costs.year4.do_nothing()).format("$0,0"), numeral(data.total_costs.year5.do_nothing()).format("$0,0"), numeral(data.total_costs.total.do_nothing()).format("$0,0")],
        ["Total Costs - Micro Focus Solution",  "-", numeral(data.total_costs.year1.mf_solution()).format("$0,0"), numeral(data.total_costs.year2.mf_solution()).format("$0,0"), numeral(data.total_costs.year3.mf_solution()).format("$0,0"), numeral(data.total_costs.year4.mf_solution()).format("$0,0"), numeral(data.total_costs.year5.mf_solution()).format("$0,0"), numeral(data.total_costs.total.mf_solution()).format("$0,0")],
        [""],
        ["QUANTITATIVE BENEFITS"],
        ["Revenues Saved", numeral(data.quantitative_benefits.year0()).format("$0,0"), numeral(data.quantitative_benefits.year1()).format("$0,0"), numeral(data.quantitative_benefits.year2()).format("$0,0"), numeral(data.quantitative_benefits.year3()).format("$0,0"), numeral(data.quantitative_benefits.year4()).format("$0,0"), numeral(data.quantitative_benefits.year5()).format("$0,0"), numeral(data.quantitative_benefits.total()).format("$0,0")],
        ["(*Revenues Saved = Total Cost of Do Notion - Total Cost of Micro Focus Solution)"]
    ];

    doc.autoTable(mf_columns, mf_rows, {
        styles:{
            overflow: 'linebreak',
            fontSize: 7,
            columnWidth: 'auto'
    ...
    function chartToPDF() {
        ...
        doc.setPage(1)
        doc.addImage(URI, 'PNG', 1, 4.18, 9, 3.75)
